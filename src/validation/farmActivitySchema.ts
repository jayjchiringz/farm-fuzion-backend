...
export const FarmDiaryEntrySchema = z.object({
  id: z.number().int().optional(),
  farmer_id: z.number().int(),
  season_id: z.number().int().optional().nullable(),
  ...
  rainfall_mm: z.number().optional().nullable(),
  related_activity_id: z.number().int().optional().nullable(),
  tags: z.array(z.string()).optional().default([]),
  images_urls: z.array(z.string()).optional().default([]),
  metadata: z.record(z.any()).optional().default({}), // Add this line
  created_at: z.string().optional(),
  updated_at: z.string().optional(),
});
